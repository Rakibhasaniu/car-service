...
const Header = () => {
    ...
    return (
        <>
   <div className="navbar bg-yellow-600 lg:px-10 fixed top-0 ">
                {/* -------------navbar start------------ */}
                <div className="navbar-start ">
                    ...
                    <div className='hidden lg:block'>
                        <div className='flex'>
                            ...
                            <Link to='/' className='mx-1 flex items-center font-bold text-2xl text-red-600'>Deshi<span className='text-black  text-4xl'>Car</span></Link>
                        </div>
                    </div>
                    {/* ------droup down -------------- */}
                    <div className="dropdown lg:hidden">
                        ...
                        <ul tabIndex={0} className="lg-header hiside menu menu-compact dropdown-content  p-2  shadow bg-slate-700  rounded-box w-60  lg:hidden">
                            ...
                            <Link to='/cetegories' className='btn'>Categories</Link>
                ...
                <div className="navbar-end">
                    ...
                    <div className="hidden lg:block mr-5">
                        ...
                        <ul className="lg-header menu menu-horizontal p-0">
                            ...
                            <Link to='/cetegories' className='btn mr-5'>Categories</Link>
