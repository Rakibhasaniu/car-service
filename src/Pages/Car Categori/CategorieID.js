                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mt-8 md:px-12 px-5 justify-center items-center">

                    {
                        singelService?.map((item, i) => <>
                            <div key={i} className="max-w-lg p-4 shadow-md bg-gray-900 text-gray-100 rounded-lg">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <h1 className=''> Market Price : <span className='text-amber-600'>{item?.ResellPrice}. </span></h1>
                                        <h1 className=''> Resell Price : <span className='text-amber-600'>{item?.orginalPrice}. </span></h1>
                                        <p className="leading-snug dark:text-gray-400">{item?.text.slice(0, 250)}</p>
                                        <div className="flex justify-center mt-3" >
                                            <label onClick={() => setBookItem(item)} htmlFor="bookin-modal" className="btn md:px-12 bg-yellow-500 text-white my-2">Booking Now</label>
